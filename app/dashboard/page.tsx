...
const uiTexts = {
  ...
  my: {
    ...
    send: "ပို့ရန်",
    placeholder: "သို့ စာပြန်ရန် ရိုက်ထည့်ပါ...",
    allClearTitle: "🎉 လိမ်လည်မှုဂိုဏ်းအားလုံးကို အောင်မြင်စွာ ဖမ်းဆီးနိုင်ခဲ့ပါသည်！",
    ...
    targetClearedTitle: "✔ ဤပစ်မှတ်ကို စုံစမ်းစစ်ဆေး ဖမ်းဆီးခြင်း ပြီးမြောက်ပါသည်",
    targetClearedDesc:
  ...
  ne: {
    ...
    typing: "टाइप गर्दैछ...",
    send: "पठाउनुहोस्",
    placeholder: "लाई जवाफ लेख्नुहोस्...",
...
const CONTACTS_MY: Contact[] = [
  // 🟢 EASY
  {
    ...
    cleared: false,
    missions: [{ id: 1, name: "အဖွဲ့အစည်း၏ တရားဝင်အမည်ကို မေးမြန်းဖော်ထုတ်ရန်", found: false }],
    description: "စမတ်ဖုန်း အပိုအလုပ်ဟု ဆိုကာ စာရင်းသွင်းကြေးများကို လိမ်လည်တောင်းခံသူ။",
  },
  {
    id: "yamada",
    ...
    cleared: false,
    missions: [{ id: 1, name: "နိုင်ငံရပ်ခြား ငွေလွှဲ ဘဏ်အကောင့်နံပါတ်ကို ဖော်ထုတ်ရန်", found: false }],
    description: "ရင်းနှီးချစ်ခင်ဟန်ဆောင်ကာ အကောက်ခွန်ကြေးအကြောင်းပြချက်ဖြင့် နိုင်ငံခြားသို့ ငွေလွှဲခိုင်းသော လိမ်လည်သူ။",
  },
  {
    id: "suzuki",
    ...
    cleared: false,
    missions: [{ id: 1, name: "ငွေတောင်းခံသော ကုမ္ပဏီအမည်ကို ဖော်ထုတ်ရန်", found: false }],
    description: "မရှိသော အခပေးဆိုက် အခကြေးငွေများကို လုပ်ကြံဖန်တီးပြီး တရားရုံးဖြင့် ခြိမ်းခြောက်ငွေညှစ်သော လိမ်လည်သူ။",
  },
  ...
  // 🟡 MEDIUM
  {
    ...
    cleared: false,
    missions: [
      { id: 1, name: "တကယ့် ရင်းနှီးမြှုပ်နှံမှု ကုမ္ပဏီအမည်ကို ဖော်ထုတ်ရန်", found: false },
      { id: 2, name: "ငွေသွင်းရမည့် VIP ဘဏ်အကောင့်ကို ဖော်ထုတ်ရန်", found: false },
    ],
    description: "ခေတ်မီ AI နည်းပညာဖြင့် အမြတ်ရမည်ဟု လှည့်စားကာ ငွေသွင်းခိုင်းသော လိမ်လည်သူ။",
  },
  {
    id: "kato",
    ...
    missions: [
      ...
      { id: 2, name: "ပစ္စည်းလွှဲပြောင်းရာ လျှို့ဝှက်နေရာကို ဖော်ထုတ်ရန်", found: false },
    ],
    description: "ငွေသားအများအပြားပေးမည်ဟု မက်လုံးပေးကာ တရားမဝင် ပစ္စည်းများ သယ်ယူခိုင်းသော ပွဲစား။",
  },
  {
    id: "watanabe",
    ...
    description: "ရရှိရန် ခက်ခဲသော ဖျော်ဖြေပွဲ လက်မှတ်များကို အကြောင်းပြကာ ငွေလိမ်လည်ယူသော ရောင်းချသူ။",
  },
  {
    id: "mori",
    ...
    preview: "လုပ်ငန်းစဉ် အခွန်အခ ယန်း ၅ သောင်း လွှဲပေးပါက ဆုငွေကို လွှဲပေးပါမည်။",
    initialMessage:
      "ဂုဏ်ယူပါသည်！ လူကြီးမင်းသည် ဒေါ်လာ ၁ သန်း ရရှိသူအဖြစ် ရွေးချယ်ခံရပါသည်။ ဆုငွေလွှဲရန် အခွန်အခကို အရင်ပေးချေပါ။",
    cleared: false,
    missions: [
      { id: 1, name: "ဖောင်ဒေးရှင်း အတုအယောင် အမည်ကို ဖော်ထုတ်ရန်", found: false },
      { id: 2, name: "အခွန်ငွေ လက်ခံသည့် ဘဏ်အကောင့်ကို ဖော်ထုတ်ရန်", found: false },
    ],
    description: "မရှိသော ထီဆုငွေများကို အကြောင်းပြပြီး ကြိုတင်အခွန်ငွေ လိမ်လည်တောင်းခံသူ။",
  },
  {
    id: "ogawa",
    ...
    cleared: false,
    missions: [
      { id: 1, name: "အတုအယောင် Exchange ကုမ္ပဏီအမည်ကို ဖော်ထုတ်ရန်", found: false },
      { id: 2, name: "ငွေသွင်းရမည့် Crypto Wallet လိပ်စာကို ဖော်ထုတ်ရန်", found: false },
    ],
    description: "ခရစ်ပတို ငွေကြေးတူးဖော်ခြင်း အကြောင်းပြကာ ငွေများကို အလွဲသုံးစားလုပ်သော လိမ်လည်သူ။",
  },
  {
    id: "hashimoto",
    ...
    cleared: false,
    missions: [
      { id: 1, name: "Escrow လိမ်လည်မှု ကုမ္ပဏီအမည်ကို ဖော်ထုတ်ရန်", found: false },
      { id: 2, name: "အာမခံကြေး လက်ခံသည့် ဘဏ်အကောင့်ကို ဖော်ထုတ်ရန်", found: false },
    ],
  ...
  // 🔴 HARD
  {
    ...
    preview: "ငါတို့ရဲ့ အချက်အလက်တွေကို ဝယ်ယူချင်ရင် တန်ဖိုးကြီးကြီး ပေးရမယ်...",
    initialMessage:
      "ငါတို့ဆီက အချက်အလက်တွေကို စိတ်ဝင်စားနေတာလား？ ဒါပေမဲ့ သာမန်လူတွေနဲ့ စကားမပြောဘူး။ မင်းဘယ်သူလဲ？",
    cleared: false,
    missions: [
      { id: 1, name: "လိမ်လည်ထားသော သတင်းအချက်အလက်ကို ဖော်ထုတ်ရန်", found: false },
      { id: 2, name: "ဂိုဏ်းချုပ်၏ တိုက်ရိုက် ID ကို ဖော်ထုတ်ရန်", found: false },
      { id: 3, name: "ဗဟို ဒေတာဘေ့စ် သိမ်းဆည်းရာ နေရာကို ဖော်ထုတ်ရန်", found: false },
    ],
    description: "တန်ဖိုးကြီး ကိုယ်ရေးအချက်အလက်များကို မှောင်ခိုရောင်းချသော လျှို့ဝှက်ဂိုဏ်းဝင်။",
  },
  {
    id: "viper",
    ...
    preview: "၂၄ နာရီအတွင်း ငွေမလွှဲရင် အချက်အလက်အားလုံးကို အင်တာနက်ပေါ် တင်မယ်...",
    initialMessage:
      "မင်းရဲ့ လျှို့ဝှက်ချက်တွေကို ငါသိထားပြီးပြီ။ အရှက်မကွဲချင်ရင် အခုပဲ ငါပြောတဲ့အတိုင်း ငွေလွှဲလိုက်！",
    cleared: false,
    missions: [
      { id: 1, name: "လိမ်လည်ထားသော လုံခြုံရေး ကုမ္ပဏီအမည်ကို ဖော်ထုတ်ရန်", found: false },
      { id: 2, name: "ငွေညှစ်ငွေ လက်ခံသည့် လျှို့ဝှက်အကောင့်ကို ဖော်ထုတ်ရန်", found: false },
      { id: 3, name: "ဗိုက်ပါ၏ ပုန်းအောင်းရာ နေရာကို ဖော်ထုတ်ရန်", found: false },
    ],
    description: "ဖောက်ထွင်းခိုးယူထားသော အချက်အလက်များဖြင့် ခြိမ်းခြောက်ငွေညှစ်သော ကျွမ်းကျင်ဟက်ကာ။",
  },
  {
    id: "shimizu",
    ...
    cleared: false,
    missions: [
      { id: 1, name: "နိုင်ငံရပ်ခြား Paper Company အမည်ကို ဖော်ထုတ်ရန်", found: false },
      { id: 2, name: "ငွေကြေးခဝါချသည့် ဘဏ်အကောင့်ကို ဖော်ထုတ်ရန်", found: false },
      { id: 3, name: "တရားမဝင် ဒစ်ဂျစ်တယ် ငွေလွှဲစင်တာကို ဖော်ထုတ်ရန်", found: false },
    ],
    description: "နိုင်ငံတကာ ဘဏ်ကွန်ရက်အတုများဖြင့် ငွေမည်းခဝါချသော ဂိုဏ်း၏ အဓိက ငွေကိုင်။",
  },
  {
    id: "kuroda",
    ...
    cleared: false,
    missions: [
      { id: 1, name: "တရားမဝင် ချေးငွေကုမ္ပဏီအမည်ကို ဖော်ထုတ်ရန်", found: false },
      { id: 2, name: "ကြွေးမြီ ပြန်လည်ကောက်ခံသည့် အကောင့်ကို ဖော်ထုတ်ရန်", found: false },
      { id: 3, name: "ငွေကြေးကောက်ခံရာ အခြေစိုက်စခန်းကို ဖော်ထုတ်ရန်", found: false },
    ],
    description: "အတိုးနှုန်း မြင့်မားစွာဖြင့် ငွေချေးပြီး အကြမ်းဖက် ငွေတောင်းခံသော ဂိုဏ်းဝင်။",
  },
  {
    id: "asuka",
    ...
    cleared: false,
    missions: [
      { id: 1, name: "ဗီဒီယိုဖန်တီးသော လျှို့ဝှက်ကုမ္ပဏီကို ဖော်ထုတ်ရန်", found: false },
      { id: 2, name: "VIP ရင်းနှီးမြှုပ်နှံမှု အကောင့်ကို ဖော်ထုတ်ရန်", found: false },
      { id: 3, name: "AI ဗီဒီယို စတူဒီယို အခြေစိုက်နေရာကို ဖော်ထုတ်ရန်", found: false },
    ],
    description: "Deepfake နည်းပညာဖြင့် နာမည်ကြီးများ၏ ပုံရိပ်အတု ပြုလုပ်၍ ငွေလိမ်လည်သူ။",
  },
  {
    id: "kiryu",
    ...
    description: "Dark Web ပေါ်တွင် အဆင့်မြင့် ဖောက်ထွင်းအချက်အလက်များကို ရောင်းဝယ်ဖောက်ကားသူ။",
  },
  {
    id: "saeki",
    ...
    missions: [
      ...
      { id: 2, name: "Ransomware လျော်ကြေး အကောင့်ကို ဖော်ထုတ်ရန်", found: false },
      { id: 3, name: "ဟက်ကာ ချန်နယ်ကို ဖော်ထုတ်ရန်", found: false },
    ],
    description: "ကုမ္ပဏီများ၏ ဒေတာများကို ပိတ်ပင်ပြီး ပြန်လည်ရယူပေးမည်ဟု ဆိုကာ ငွေညှစ်သော ကြားခံလူ။",
  },
  {
    id: "tachibana",
    ...
    cleared: false,
    missions: [
      { id: 1, name: "မြေအောက်ဘဏ်အမည်နှင့် စင်တာကို ဖော်ထုတ်ရန်", found: false },
      { id: 2, name: "ဗဟို ထိန်းချုပ်ရေး အကောင့်ကို ဖော်ထုတ်ရန်", found: false },
      { id: 3, name: "မှောင်ခို ငွေလွှဲကွန်ရက် တစ်ခုလုံးကို ဖော်ထုတ်ရန်", found: false },
    ],
    description: "တရားမဝင် ငွေကြေးများကို နိုင်ငံရပ်ခြားသို့ လျှို့ဝှက်လွှဲပြောင်းပေးသော မြေအောက်ဘဏ် မန်နေဂျာ။",
  },
  {
    id: "kisaragi",
    ...
    cleared: false,
    missions: [
      { id: 1, name: "လှည့်စားထားသော သတင်းအချက်အလက်ကို ဖော်ထုတ်ရန်", found: false },
      { id: 2, name: "ဗဟို ညွှန်ကြားရေး ဌာနချုပ်ကို ဖော်ထုတ်ရန်", found: false },
      { id: 3, name: "လျှို့ဝှက် ဆက်သွယ်ရေး ချန်နယ်ကို ဖော်ထုတ်ရန်", found: false },
    ],
    description: "စုံစမ်းရေးမှူးများကို စိတ်ပိုင်းဆိုင်ရာ ခြိမ်းခြောက်ပြီး လှည့်ဖြားတတ်သော ဂိုဏ်း၏ ထိပ်တန်း အေးဂျင့်။",
  },
  ...
  // 👑 MASTER
  {
    ...
    cleared: false,
    missions: [
      { id: 1, name: "ဂိုဏ်းချုပ်၏ အမည်ရင်းနှင့် အခြေစိုက်စခန်းကို ဖော်ထုတ်ရန်", found: false },
      { id: 2, name: "ဂိုဏ်းတစ်ခုလုံး၏ ဘဏ်အကောင့်အားလုံးကို သိမ်းဆည်းရန်", found: false },
      { id: 3, name: "ဂိုဏ်းပြိုကွဲစေမည့် လျှို့ဝှက်ကုဒ်ကို ရယူရန်", found: false },
    ],
    description: "နိုင်ငံတကာ လိမ်လည်မှု ကွန်ရက်တစ်ခုလုံး၏ အမြင့်ဆုံး ခေါင်းဆောင်ကြီး။",
  },
];
...
const CONTACTS_NE: Contact[] = [
  // 🟢 EASY
  {
    ...
    cleared: false,
    missions: [{ id: 1, name: "संस्थाको आधिकारिक नाम पत्ता लगाउनुहोस्", found: false }],
  ...
  },
  {
    ...
    cleared: false,
    missions: [{ id: 1, name: "विदेशमा रकम पठाउने खाता नम्बर पत्ता लगाउनुहोस्", found: false }],
    description: "मायाको नाटक गरी भन्सार शुल्कको बहानामा विदेशमा रकम पठाउन लगाउने अन्तर्राष्ट्रिय ठग।",
  },
  {
    id: "suzuki",
    ...
    cleared: false,
    missions: [{ id: 1, name: "बिलिङ गर्ने कम्पनीको नाम पत्ता लगाउनुहोस्", found: false }],
    description: "नक्कली बक्यौताको नाममा अदालतको धम्की दिएर रकम असुल्ने अपराधी।",
  },
  ...
  // 🟡 MEDIUM
  {
    ...
    preview: "महिनामा ३०% नाफाको ग्यारेन्टी भएको भीआईपी खातामा रकम पठाउनुहोस्...",
    initialMessage:
      "नमस्ते! तपाईंको लागि विशेष एआई लगानी अवसर ल्याएको छु। रकम जम्मा गर्न तयार हुनुहुन्छ?",
    cleared: false,
    missions: [
      { id: 1, name: "वास्तविक लगानी कम्पनीको नाम पत्ता लगाउनुहोस्", found: false },
      { id: 2, name: "भीआईपी रकम जम्मा गर्ने खाता पत्ता लगाउनुहोस्", found: false },
    ],
  ...
  },
  {
    ...
    missions: [
      ...
      { id: 2, name: "सामान हस्तान्तरण गर्ने गोप्य स्थान पत्ता लगाउनुहोस्", found: false },
    ],
  ...
  },
  {
    ...
    cleared: false,
    missions: [
      { id: 1, name: "नक्कली पसलको आधिकारिक नाम पत्ता लगाउनुहोस्", found: false },
      { id: 2, name: "भुक्तानी गर्ने बैंक खाता पत्ता लगाउनुहोस्", found: false },
    ],
  ...
  },
  {
    ...
    missions: [
      ...
      { id: 2, name: "कर प्राप्त गर्ने बैंक खाता पत्ता लगाउनुहोस्", found: false },
    ],
  ...
  },
  {
    ...
    cleared: false,
    missions: [
      { id: 1, name: "नक्कली एक्सचेन्ज संस्थाको नाम पत्ता लगाउनुहोस्", found: false },
  ...
  // 🔴 HARD
  {
    ...
    missions: [
      ...
      { id: 3, name: "केन्द्रीय डाटाबेस सर्भर स्थान पत्ता लगाउनुहोस्", found: false },
    ],
    description: "महत्त्वपूर्ण व्यक्तिगत विवरणहरू कालोबजारी गर्ने उच्च सिन्डिकेट सदस्य।",
  },
  {
    id: "viper",
    ...
    cleared: false,
    missions: [
      { id: 1, name: "नक्कली सुरक्षा कम्पनीको नाम पत्ता लगाउनुहोस्", found: false },
      { id: 2, name: "असुली रकम जम्मा गर्ने खाता पत्ता लगाउनुहोस्", found: false },
  ...
  },
  {
    ...
    missions: [
      ...
      { id: 2, name: "सम्पत्ति शुद्धीकरण गर्ने बैंक खाता पत्ता लगाउनुहोस्", found: false },
      { id: 3, name: "अवैध क्रिप्टो हब स्थान पत्ता लगाउनुहोस्", found: false },
    ],
    description: "कालोधनलाई विभिन्न विदेशी खाताहरू मार्फत शुद्धीकरण गर्ने मुख्य वित्तीय निर्देशक।",
  },
  {
    id: "kuroda",
  ...
  },
  {
    ...
    cleared: false,
    missions: [
      { id: 1, name: "भिडियो निर्माण गर्ने कम्पनीको नाम पत्ता लगाउनुहोस्", found: false },
      { id: 2, name: "भीआईपी लगानी खाता पत्ता लगाउनुहोस्", found: false },
      { id: 3, name: "एआई स्टुडियोको स्थान पत्ता लगाउनुहोस्", found: false },
    ],
    description: "डिपफेक प्रविधिबाट चर्चित व्यक्तिहरूको नक्कली भिडियो बनाई ठगी गर्ने व्यक्ति।",
  },
  {
    id: "kiryu",
    ...
    description: "डार्क वेबमा गोप्य व्यक्तिगत विवरणहरू अवैध रूपमा किनबेच गर्ने दलाल।",
  },
  {
    id: "saeki",
    ...
    description: "कम्पनीको डाटा बन्दक बनाई मध्यस्थताको नाममा फिरौती असुल्ने व्यक्ति।",
  },
  {
    id: "tachibana",
    ...
    missions: [
      ...
      { id: 2, name: "केन्द्रीय नियन्त्रण खाता पत्ता लगाउनुहोस्", found: false },
      { id: 3, name: "छाया मार्गको सम्पूर्ण सञ्जाल पत्ता लगाउनुहोस्", found: false },
    ],
    description: "कालोधनलाई बिना अभिलेख विदेशमा स्थानान्तरण गर्ने भूमिगत बैंक सञ्चालक।",
  },
  {
    id: "kisaragi",
    ...
    description: "अनुसन्धानकर्ताहरूलाई मानसिक दबाब र भ्रम सिर्जना गरी झुक्याउने सिन्डिकेटको शीर्ष गुप्तचर।",
  },
  ...
  // 👑 MASTER
  {
    ...
    cleared: false,
    missions: [
      { id: 1, name: "नाइकेको वास्तविक नाम र मुख्य अखडा पत्ता लगाउनुहोस्", found: false },
      { id: 2, name: "सिन्डिकेटका सम्पूर्ण बैंक खाताहरू जफत गर्नुहोस्", found: false },
      { id: 3, name: "सिन्डिकेट पतन गराउने गोप्य कोड प्राप्त गर्नुहोस्", found: false },
    ],
    description: "सम्पूर्ण अन्तर्राष्ट्रिय ठगी सिन्डिकेटको सर्वोच्च योजनाकार र नाइके।",
  },
];
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    const initDashboard = async () => {
      ...
      const savedLang =
        (localStorage.getItem("scam_lang") as "ja" | "en" | "my" | "ne") || "ja";
      ...
      const applyUserData = (name: string, mail: string) => {
        ...
        const activeContacts = savedLang === "en" ? CONTACTS_EN : savedLang === "my" ? CONTACTS_MY : savedLang === "ne" ? CONTACTS_NE : CONTACTS_JA;
  ...
  const handleRetryContact = (contactId: string) => {
    const activeContacts = lang === "en" ? CONTACTS_EN : lang === "my" ? CONTACTS_MY : lang === "ne" ? CONTACTS_NE : CONTACTS_JA;
    const initialMsg =
            ...
            if (c.id === targetContactId && !c.cleared) {
              ...
              if (allMissionsFound && !c.cleared) {
                ...
                if (c.dangerLevel === "easy" && currentEasyCleared + 1 >= 3) {
                  ...
                  const bossNameList = lang === "en" ? ENDLESS_BOSS_NAMES_EN : lang === "my" ? ENDLESS_BOSS_NAMES_MY : lang === "ne" ? ENDLESS_BOSS_NAMES_NE : ENDLESS_BOSS_NAMES_JA;
                  const nextBossName =
  ...
  const handleLanguageChange = (newLang: "ja" | "en" | "my" | "ne") => {
    ...
    const newContactsBase = newLang === "en" ? CONTACTS_EN : newLang === "my" ? CONTACTS_MY : newLang === "ne" ? CONTACTS_NE : CONTACTS_JA;
    setContacts((prevContacts) => {
